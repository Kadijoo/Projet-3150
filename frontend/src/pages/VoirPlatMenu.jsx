            ...
            <>
              ...
              {plats.length === 0 ? (
                <div className="empty-container">
                  <p style={{ fontSize: "100px", margin: 0 }}>🍽️</p>
                  <p>Aucun plat créé.</p>
                  <button onClick={() => navigate("/creer-plat-menu?type=plat")} className="empty-button">
                          Créer un plat
                  </button>
                </div>  
              ) : (
            ...
            <>
              ...
              {menus.length === 0 ? (
                <div className="empty-container">
                  ...
                  <p>Aucun menu créé.</p>
                  <button onClick={() => navigate("/creer-plat-menu?type=menu")} className="empty-button">
                      Créer un menu
                  </button>
                </div>   
              ) : (
